...
<div class="ui container">
    ...
    <div class="ui grid">
        ...
        <div class="twelve wide column">
            ...
            <!-- Child Registration Form (hidden by default) -->
            <div id="childRegistrationForm" style="display: none;">
                ...
                if(isset($_POST['submit_child'])) {
                    ...
                    $sql = "INSERT INTO child_registration_requests (cname, cdob, cyoe, cclass, cstory, cphoto) VALUES ('$child_name', '$child_dob', '$child_yoe', '$child_class', '$child_story_behind', '$child_pic')";
